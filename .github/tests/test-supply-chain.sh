...
check_file_contains "${RELEASE_YML}" ".github/scripts/release-guard.sh assets" "release.yml uploads binaries through the guard"
...
check_file_contains "${DOCKER_YML}" ".github/scripts/release-guard.sh image" "release-docker.yml guards the fixed image tag"
